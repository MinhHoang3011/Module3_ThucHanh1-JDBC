package com.example.thuchanhusemanager.controller;

import com.example.thuchanhusemanager.dao.UserDAO;
import com.example.thuchanhusemanager.model.User;
...
public class UserServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request, HttpServletResponse response) throws IOException,SQLException,ServletException {
        ...
        User setUser = new User(id,name,email,country);
        userDAO.updateUser(setUser);
